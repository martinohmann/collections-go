...
// Int32 is a collection of int32 values.
type Int32 struct {
	items []int32
}

// NewInt32 creates a new collection from a slice of int32.
...
func (c *Int32) Each(fn func(int32)) {
...
func (c *Int32) IndexOf(el int32) int {
	for i, item := range c.items {
		if item == el {
			return i
		}
...
func (c *Int32) FirstN(n int) []int32 {
	if n > c.Len() {
		return c.Items()
	}
...
// false and returns c.
func (c *Int32) Filter(fn func(int32) bool) *Int32 {
	s := c.items[:0]
...
// false and returns c.
func (c *Int32) Collect(fn func(int32) bool) *Int32 {
	return c.Filter(fn)
}

// Reject removes all items from the collection for which fn evaluates to
// true and returns c.
func (c *Int32) Reject(fn func(int32) bool) *Int32 {
...
func (c *Int32) Partition(fn func(int32) bool) (*Int32, *Int32) {
	...
	return NewInt32(lhs), NewInt32(rhs)
}
...
func (c *Int32) Reduce(fn func(reducer int32, item int32) int32) int32 {
	var reducer int32
...
func (c *Int32) Find(fn func(int32) bool) int32 {
	item, _ := c.FindOk(fn)
...
func (c *Int32) FindOk(fn func(int32) bool) (int32, bool) {
	for _, item := range c.items {
		if fn(item) {
			return item, true
		}
...
func (c *Int32) Any(fn func(int32) bool) bool {
	for _, item := range c.items {
		if fn(item) {
			return true
		}
...
func (c *Int32) All(fn func(int32) bool) bool {
	for _, item := range c.items {
		if !fn(item) {
			return false
		}
...
func (c *Int32) Contains(el int32) bool {
	for _, item := range c.items {
		if item == el {
			return true
		}
...
func (c *Int32) Sort(fn func(int32, int32) bool) *Int32 {
...
func (c *Int32) IsSorted(fn func(int32, int32) bool) bool {
	return sort.SliceIsSorted(c.items, c.lessFunc(fn))
}

func (c *Int32) lessFunc(fn func(int32, int32) bool) func(int, int) bool {
...
func (c *Int32) RemoveItem(item int32) *Int32 {
...
func (c *Int32) Slice(i, j int) []int32 {
	return c.items[i:j]
}
